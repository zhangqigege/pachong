 ...
 */
public class URLConnIOS8859Test {
    ...
    public static void url(String path) throws Exception {
        ...
        try {
            ...
            writer2 = new BufferedWriter(new OutputStreamWriter(new FileOutputStream("E://IOS8859.txt")));
            String read;
            System.out.println("加密");
            while ((read = reader.readLine()) != null){
                writer.write(read);
                read = new String(read.getBytes("UTF-8"),"iso-8859-1");
                writer2.write(read);
            }
        }catch (Exception e){
            e.printStackTrace();
